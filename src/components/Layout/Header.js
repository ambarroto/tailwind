...
const Header = () => {
    return (
        <div>
            {/* Code block starts */}
            <div className="my-6 lg:mb-12 container pb-6 mx-auto flex flex-col md:flex-row items-start md:items-center justify-between pb-4 border-b border-gray-300">
                <div>
